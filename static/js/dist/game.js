...
class NoticeBoard extends AGameObject{
    constructor(playground) {
        super();
...
}class Particle extends AGameObject {
...
`);
    ...
    login_on_remote() {  // 在远程服务器上登录
        ...
        $.ajax({
           url: "https://app3749.acapp.acwing.com.cn/settings/login",
            type: "GET",
            data: {
               username: username,
               password: password,
    ...
    register_on_remote() {  // 在远程服务器上注册
        ...
        $.ajax({
            url: "https://app3749.acapp.acwing.com.cn/settings/register/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    logout_on_remote() {  // 在远程服务器上登出
        if (this.platform === "ACAPP") {
            ...
            $.ajax({
                url: "https://app3749.acapp.acwing.com.cn/settings/logout",
                type: "GET",
                success: function (resp) {
                    // console.log(resp);
                    if (resp.result === "success") {
